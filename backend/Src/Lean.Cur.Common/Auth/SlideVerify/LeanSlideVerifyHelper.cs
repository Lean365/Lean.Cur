...
/// 滑块验证码工具类
/// </summary>
public class LeanSlideVerifyHelper
{
  private readonly LeanSlideVerifyOptions _options;
  private readonly IMemoryCache _cache;
  private readonly Random _random;

  public LeanSlideVerifyHelper(IOptions<LeanSlideVerifyOptions> options, IMemoryCache cache)
  {
  ...
  /// 生成滑块验证码
  /// </summary>
  public LeanSlideVerifyResult Generate()
  {
    // 获取随机背景图和滑块图
    ...
    return new LeanSlideVerifyResult
    {
      Id = id,
  ...
  public LeanSlideVerifyResult Verify(int x, int y)
  {
    var id = Guid.NewGuid().ToString("N");
    // ... existing code ...
    return new LeanSlideVerifyResult
