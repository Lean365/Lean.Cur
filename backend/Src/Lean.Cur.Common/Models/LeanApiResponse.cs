...
/// API响应模型（泛型）
/// </summary>
public class LeanApiResponse<T> : LeanApiResponse
{
  /// <summary>
  /// 响应数据
  /// </summary>
  ...
  /// 创建成功响应
  /// </summary>
  public static LeanApiResponse<T> Success(T data)
  {
  ...
  /// 创建失败响应
  /// </summary>
  public static LeanApiResponse<T> Error(LeanErrorCode code, string message)
  {
    return new LeanApiResponse<T>
    {
      Code = code,
